...
import 'package:nowlii/experimental/reminder/error_red.dart';
import 'package:nowlii/experimental/reminder/quest_suggestion_purple.dart';
import 'package:nowlii/experimental/reminder/success_green.dart';
...
import 'package:nowlii/screen/reminder_notification/ai_call_reminder/default_yellow/default_yellow.dart';
import 'package:nowlii/themes/create_qutes.dart';
import 'package:nowlii/themes/text_styles.dart';
import 'package:nowlii/utils/color_palette/color_palette.dart';

class ReminederNotifications extends StatefulWidget {
  const ReminederNotifications({super.key});

  @override
  State<ReminederNotifications> createState() => _ReminederNotificationsState();
}

class _ReminederNotificationsState extends State<ReminederNotifications> {
...
class _OnboardingDialogState extends State<OnboardingDialog>
  ...
  final List<OnboardingStep> _steps = [
    ...
    OnboardingStep(
      widget: const SuccessGreen(),
      position: const Alignment(0.5, 0),
    ),
    OnboardingStep(
      widget: const ErrorRed(),
      position: const Alignment(-0.5, 0.4),
    ),
    OnboardingStep(
      widget: const QuestSuggestionPurpleq(),
